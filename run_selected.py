...
def run_appearance_transfer(model: AppearanceTransferModel, cfg: RunConfig) -> List[Image.Image]:
    ...
    #             for range_end_FEAT in range(0,101,20):
    #                 torch.cuda.empty_cache()
    #                 if not(range_start_FEAT == 0 or range_start_FEAT == 100):
    #                     continue
    #                 if not(range_end_FEAT == 0 or range_end_FEAT == 100):
    #                     continue
    #                 if os.path.exists(cfg.output_path / f"out_transfer---seed_{cfg.seed}__FEAT_{range_start_FEAT}_{range_end_FEAT}__AdaIN_{range_start_ADAIN}_{range_end_ADAIN}.png"):
    #                     continue
